...
describe('framework/helpers/date/getMonthDifference', () => {
...
describe('framework/helpers/date/checkingIfDateIsGreaterThanAnotherIgnoringTime', () => {
  beforeEach(() => {
...
describe('framework/helpers/date/resetTimeFromDate', () => {
...
describe('framework/helpers/date/isCurrentMonthAndYear', () => {
...
describe('framework/helpers/date/getMonthByIndex', () => {
